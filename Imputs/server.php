...
echo "Link: " . (isset($_POST['url']) ? limpiar($_POST['url']) : "No enviado") . "<br>";
...
echo "Pelicula favorita: " . (isset($_POST['select']) ? limpiar($_POST['select']) : "No enviada") . "<br>";
echo "¿Cómo te sientes?: " . (isset($_POST['text']) ? limpiar($_POST['text']) : "No enviado") . "<br>";

echo "Estado de Ánimo: " . (isset($_POST['genero']) ? limpiar($_POST['genero']) : "No enviado") . "<br>";
echo "Color: " . (isset($_POST['color']) ? limpiar($_POST['color']) : "No enviado") . "<br>";
echo "¿Cuanto te gusta las golosinas?: " . (isset($_POST['range']) ? limpiar($_POST['range']) : "No enviado") . "<br>";
